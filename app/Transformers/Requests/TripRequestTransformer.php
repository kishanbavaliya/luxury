...
class TripRequestTransformer extends Transformer
{
    ...
    public function transform(RequestModel $request)
    {
        $params =  [
            ...
            'is_driver_confirm' => $request->is_driver_confirm,
            ...
            'customer_no_show'=>$request->customer_no_show,
            'customer_no_show_file'=>$request->customer_no_show_file,
            'driver_no_show'=>$request->driver_no_show,
