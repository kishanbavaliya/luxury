...
class DriverProfileTransformer extends Transformer
{
    ...
    protected array $availableIncludes = [
        'onTripRequest','metaRequest', 'metaRequests'
    ];
...
Log::info('from driver - '.$user->id);
    ...
    */
     ...
     * @return \League\Fractal\Resource\Collection|\League\Fractal\Resource\NullResource
     */
    public function includeMetaRequests(Driver $user)
    {
        $request_meta_list = RequestMeta::with('request')->where('driver_id', $user->id)->where('active', true)
