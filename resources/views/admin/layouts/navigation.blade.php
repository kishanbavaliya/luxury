      ...
      @endif
        ...
        @endif
         ...
         @if(auth()->user()->can('cancellation-rides'))
          ...
          @endif
          @if(auth()->user()->can('no-show-driver-rides'))
            <li class="{{'no-show-driver-rides' == $sub_menu ? 'active' : '' }}">
              <a href="{{url('/no-show-driver-rides')}}">
                <i class="fa fa-circle-thin"></i> <span>No Driver Show Rides</span>
              </a>
            </li>
          @endif
