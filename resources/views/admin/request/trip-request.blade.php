                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                               ...
                                               @else --}}
                                                ...
                                                <p class="mb-1 f-12">
                                                     Email : <b>{{ $item->userDetail ? $item->userDetail->email : "" }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Adults : <b>{{ $item->adults }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Childrens : <b>{{ $item->childrens }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Infants : <b>{{ $item->infants }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Flight Number : <b>{{ $item->flight_number }}</b>
                                                </p>
                                                {{-- <p class="mb-1 f-12">
                                                    Seats Accessories : <b>{{ $item->seats_accessories }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Seats Accessories Amount : <b>{{ $item->seats_accessories_amount ?? 0 }}</b>
                                                </p> --}}
                                                <p class="mb-1 f-12">
                                                    Baby Bucket (up to 1 year) : <b>{{ $item->baby_bucket ?? 0 }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Child Seat (1-3 years) : <b>{{ $item->child_seat ?? 0 }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Booster Seat (3-6 years) : <b>{{ $item->booster_seat ?? 0 }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Notes For Chauffeuer : <b>{{ $item->notes_for_chauffeuer }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Sign Board Name : <b>{{ $item->sign_board_name }}</b>
                                                </p>
                                                {{-- @endif --}}
                                            </div>
                                    ...
                                    <div class="col card detail-overflow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <p class="mb-1 f-12">
                                                    Total Fare :
                                                        <b>{{ $item->request_eta_amount }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Driver Payment :
                                                        <b>{{ $item->request_eta_amount - $Commission }}</b>
                                                </p>
                                                <p class="mb-1 f-12">
                                                    Commission :
                                                        <b>{{ $Commission }}</b>
                                            ...
                                            @if ($item->zoneType->vehicleType)
                                                ...
                                                <div class="col-7 my-3">
                                                    ...
                                                    <p class="mb-1 f-12">
                                                       @lang('view_pages.make') :
                                                        <b>{{ ($item->driverDetail && $item->driverDetail->carMake) ? $item->driverDetail->carMake->name : '-' }}</b>
                                                    </p>
                                                    <p class="mb-1 f-12">
                                                         @lang('view_pages.model') :
                                                        <b>{{ ($item->driverDetail && $item->driverDetail->carModel) ? $item->driverDetail->carModel->name : '-' }}</b>
                                                    </p>
                                                </div>
                                            @endif
