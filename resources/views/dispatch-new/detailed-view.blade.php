...
@foreach($data as $k=>$v)
 ...
 @endif
    ...
    <div class="content">
      ...
      <p style="position: relative; top: 25px;">{{ isset($v->created_at) ? \Carbon\Carbon::parse($v->created_at)->setTimezone($timezone)->format('d,M y h:i A') : "" }} </p>
...
<!-- user details -->
              <div class="g-col-12 g-col-lg-6 g-col-xl-6">
                  ...
                  <div class="g-col-12 g-col-sm-12 g-col-xxl-3 p-10">
                        <div class="d-flex">
                            <i data-feather="user"></i>
                            <div class="fw-medium vd1 ms-2">Name : {{ $item->userDetail ? $item->userDetail->name : $item->adHocuserDetail->name  }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Mobile : {{ $demo=='demo' ? '***********' : ( $item->userDetail ? $item->userDetail->mobile : $item->adHocuserDetail->mobile) }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Email : {{ $demo=='demo' ? '***********' : ( $item->userDetail ? $item->userDetail->email : "") }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Adults : {{ $item->adults }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Childrens : {{ $item->childrens }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Infants : {{ $item->infants }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Flight Number : {{ $item->flight_number }}</div>
                        </div>
                        {{-- <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Seats Accessories : {{ $item->seats_accessories }}</div>
                        </div> --}}
                        {{-- <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Seats Accessories Amount : {{ $item->seats_accessories_amount ?? 0 }}</div>
                        </div> --}}
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Baby Bucket (up to 1 year) : {{ $item->baby_bucket ?? 0 }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Child Seat (1-3 years) : {{ $item->child_seat ?? 0 }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Booster Seat (3-6 years) : {{ $item->booster_seat ?? 0 }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Notes For Chauffeuer : {{ $item->notes_for_chauffeuer }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <i data-feather="smartphone"></i>
                            <div class="fw-medium vd1 ms-2">Sign Board Name : {{ $item->sign_board_name }}</div>
                        </div>
                  </div>
                </div>
              </div>
              ...
              <div class="g-col-12 g-col-lg-6 g-col-xl-6">
                  ...
                  <div class="g-col-12 g-col-sm-12 g-col-xxl-3 p-10">
                        ...
                        <div class="d-flex mt-4">
                            ...
                            <div class="fw-medium vd1 ms-2">{{ $item->request_eta_amount }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <div class="me-auto vd">Driver Payment</div>
                            <div class="fw-medium vd1 ms-2">{{ $item->request_eta_amount - $Commission }}</div>
                        </div>
                        <div class="d-flex mt-4">
                            <div class="me-auto vd">Commission</div>
                            <div class="fw-medium vd1 ms-2">{{ $Commission }}</div>
                        </div>
                  </div>
                </div>
              </div>
