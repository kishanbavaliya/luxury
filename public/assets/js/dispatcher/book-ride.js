        ...
        var stop_data = [];
         var delivery_map;
                ...
                function createTripRequest(data_modal) {
                    ...
                    var not_include_owners = [];
                    var include_owner = [];
                    $('#not_include_owner option:selected').each(function () {
                        not_include_owners.push($(this).val());
                    });
                    $('#include_owner option:selected').each(function () {
                        include_owner.push($(this).val());
                    });
                    ...
                    // var seats_accessories = document.getElementById('seats_accessories').value;
                    // var seats_accessories_amount = document.getElementById('seats_accessories_amount').value;
                    var baby_bucket = document.getElementById('baby_bucket').value;
                    var child_seat = document.getElementById('child_seat').value;
                    var booster_seat = document.getElementById('booster_seat').value;
                    var notes_for_chauffeuer = document.getElementById('notes_for_chauffeuer').value;
                    var sign_board_name = document.getElementById('sign_board_name').value;
                    var refrence_name = document.getElementById('refrence_name').value;
                    var refrence_short_name = document.getElementById('refrence_short_name').value;
                    ...
                    console.log(refrence_name,include_owner);debugger;
                    var tripData = {
                        'vehicle_type': typeId,
                        'payment_opt': 1,
                        'pick_lat': pick_lat,
                        ...
                        'pickup_poc_mobile': sender.phone,
                         ...
                         'not_include_owners': not_include_owners,
                            'transport_type':'taxi',
                            'assign_method':assign_method,
                         'dial_code':dialCode,
                         'surname':surname,
                           'refrence_name':refrence_name,
                         'refrence_short_name':refrence_short_name,
                         'email':email,
                         'adults':adults,
                         'childrens':childrens,
                         'infants':infants,
                         'flight_number':flight_number,
                         'baby_bucket':baby_bucket,
                         'child_seat':child_seat,
                         'booster_seat':booster_seat,
                        //  'seats_accessories':seats_accessories,
                        //  'seats_accessories_amount':seats_accessories_amount,
                         'notes_for_chauffeuer':notes_for_chauffeuer,
        ...
        geocoder.geocode({ 'location': drop }, function(responses) {
            if (responses && responses.length > 0) {
                ...
                $(document).on('click', '.selectTypePackage', function() {
                    ...
                    $("#own_price").val(packagePrice.toFixed(2));
                    $('.etatime').html(
