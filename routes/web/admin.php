...
use App\Http\Controllers\Web\Admin\ReferenceController;
...
// revert_deleted
        ...
        Route::group(['prefix' => 'delivery-requests',  'middleware' => 'permission:view-delivery-requests'], function () {
         ...
         Route::group(['prefix' => 'scheduled-rides',  'middleware' => 'permission:view-requests'], function () {
            ...
            Route::get('/no-driver-show-rides', 'RequestController@noDriverShowRides');
        ...
        Route::group(['prefix' => 'no-show-driver-rides',  'middleware' => 'permission:view-requests'], function () {
            Route::get('/', 'NoShowDriverController@index');
            Route::get('/fetch', 'NoShowDriverController@getAllRides');
            Route::get('/get-no-driver-show-document/{id}', 'NoShowDriverController@getDocument')->name('no-driver-show-document');
            Route::get('/approve-ride/{id}', 'NoShowDriverController@approveRide')->name('approve-no-show-driver-document');
        ...
        Route::group(['prefix' => 'reports',  'middleware' => 'permission:reports'], function () {
            ...
            Route::get('/revenue', 'ReportController@revenueReport')->name('revenueReport');
            Route::get('/commission', 'ReportController@commissionReport')->name('commissionReport');
            Route::get('/star-ratings', 'ReportController@starRatingReport')->name('starRatingReport');
            Route::get('/completed-rides', 'ReportController@completeRidesReport')->name('completeRidesReport');
            Route::get('/company-tag-integration', 'ReportController@companyTagReport')->name('companyTagReport');
            Route::get('/pdf', 'ReportController@pdfReport')->name('pdfReport');
            Route::get('/pdf/download', 'ReportController@downloadPDF')->name('downloadPDF');
            Route::get('/pdf', 'ReportController@pdfReport')->name('pdfReport');
        });
...
Route::middleware('auth:web')->namespace('Admin')->group(function () {
    ...
    Route::post('/store-booking', 'DispatcherController@store')->name('dispatcher.store.booking');

    Route::post('/cancel-ride/{id}', 'DispatcherController@cancelRide')->name('dispatcher.cancel.ride');
